<template>
    <div :class="useThemeSettingsStore().semidark ? 'dark' : ''">
        ...
        useThemeSettingsStore().skin === 'bordered'
          ...
          : 'shadow-base'
      }   ${useThemeSettingsStore().sidebarCollasp ? closeClass : openClass}
...
const menuItems = computed(() => [
    ...
    {
        title: useI18n().t('dashboard.countries'),
        icon: "heroicons:globe-asia-australia-20-solid",
        link: "#",
        child: [
            {
                childtitle: useI18n().t('dashboard.countries_create'),
                childlink: 'countries.create',
            },
            {
                childtitle: useI18n().t('dashboard.countries_index'),
                childlink: 'countries.index',
            },
        ],
    },
    {
    ...
    {
        title: useI18n().t('dashboard.users'),
        icon: "heroicons:user-20-solid",
        link: "#",
        child: [
            {
                childtitle: useI18n().t('dashboard.users_create'),
                childlink: 'users.create',
            },
            {
                childtitle: useI18n().t('dashboard.users_index'),
                childlink: 'users.index',
            },
        ],
    },
    {
        title: useI18n().t('dashboard.articles'),
        icon: "heroicons:book-open",
        link: "#",
        child: [
            {
                childtitle: useI18n().t('dashboard.articles_create'),
                childlink: 'articles.create',
            },
            {
                childtitle: useI18n().t('dashboard.articles_index'),
                childlink: 'articles.index',
            },
        ],
    },
    {
        isHeadr: true,
        title: useI18n().t('dashboard.translations'),
    },
    {
        title: useI18n().t('dashboard.languages'),
